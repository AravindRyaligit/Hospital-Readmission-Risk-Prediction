...
class XGBoostTrainer:
    ...
    def evaluate(self, X_test, y_test):
        ...
        logger.info(f"XGBoost AUC-ROC: {auc_roc:.4f}")
    ...
    def plot_feature_importance(self, top_n=20):
        ...
        plot_path = REPORTS_DIR / 'xgboost_feature_importance.png'
    ...
    def plot_roc_curve(self, y_test, y_pred_proba):
        ...
        plot_path = REPORTS_DIR / 'xgboost_roc_curve.png'
        plt.savefig(plot_path, dpi=300, bbox_inches='tight')
    ...
    def plot_confusion_matrix(self, y_test, y_pred):
        ...
        plot_path = REPORTS_DIR / 'xgboost_confusion_matrix.png'
        plt.savefig(plot_path, dpi=300, bbox_inches='tight')
    ...
    def save_model(self):
        """Save trained model"""
        save_model(self.model, XGBOOST_MODEL_FILE)
        
        # Save best parameters
        params_path = MODELS_DIR / 'xgboost_params.json'
        save_json(self.best_params, params_path)
        
        # Save feature importance
        importance_path = REPORTS_DIR / 'xgboost_feature_importance.csv'
